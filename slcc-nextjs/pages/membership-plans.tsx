...
export default function MembershipPlansPage() {
  return (
    <GenericTablePage
      ...
      fields={[
        { key: 'plan_code',    label: 'Plan Code', required: true, placeholder: 'PLN-GOLD' },
        { key: 'plan_name_zh', label: '方案名稱', required: true },
        { key: 'plan_name_en', label: 'Plan Name', required: true },
        { key: 'tier',         label: 'Tier', placeholder: 'e.g. Gold, Silver, Bronze' },
